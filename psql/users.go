...
// Find will retrieve a user with the provided ID or return ErrNotFound if the user isn't located. Other errors are wrapped with context but are otherwise wrapped as-is
...
// Delete wil delete a user from the DB. If there is an error it will be wrapped and returned
